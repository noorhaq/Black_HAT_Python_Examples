...
target_host = '127.0.0.1'   #Website you want to connect with
target_port = 10000             #Target site port which is open for data transfer
...
#sending data
client.send(str.encode("AAABBBBBC"))
#client.sendto("AAABBBBBC",(target_host,target_port))
